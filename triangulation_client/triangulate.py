...
import operator
import argparse
from xlr import LatLonConversion
import numpy
import requests, csv

# radio1 northwest corner, radio2 northeast corner, radio3 is southeast corner
# python trigV2.py -radio1 40.732116 -73.998630 -radio2 40.730692 -73.995657 -radio3 40.729598 -73.996584
try: 
    three_d = False

    # command line input ex: python trigV2.py -radio1 x y z -radio2 x y z -radio3 x y z --three_d
    ...
    error = "Invalid command line arguments. Proper usage ex: "
    error += "\n triangulate.py -radio1 40.732116 -73.998630 -radio2 40.730692 -73.995657 -radio3 40.729598 -73.996584"
...
# set data rates for each radio to 4
data_rate = 'br4'
...
#distances to target
# for i in range(20):
while total_range14<5 or total_range24<5 or total_range34 < 5 :
    # 1 + 4
    ...
    print "range14", total_range14
    print "range24", total_range24
    print "range34", total_range34
...
while 1 < 100:
    try: 
        ...
        # points = { "radio_4": [p4_coords[0], p4_coords[1]] }

        p4 = [p4_coords[0], p4_coords[1]]

        p4_dict = {"point": [p4_coords[0], p4_coords[1]]}

        with open('park_triangulation.csv', 'a') as fp:
            a = csv.writer(fp, delimiter=',')
            row = [radio1, radio2, radio3, radio4, p4 ]
            a.writerow(row)

        print json.dumps(p4_dict)

        r = requests.post("http://104.131.56.21:3000/sendData", data=p4_dict)
    except:
        continue
